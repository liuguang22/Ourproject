...
public class shopping extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1=findViewById(R.id.xq_mj);
//        c2=findViewById(R.id.xq_ct);
        c3=findViewById(R.id.xq_dz);
...
//        c2.setText(intent.getStringExtra("createtime"));
        ...
        sc =(Button) findViewById(R.id.xq_sc);
        sc.setOnClickListener(this);
        buy =(Button) findViewById(R.id.xq_buy);
    ...
    public void onClick(View view) {
        ...
        else if (view.getId()==R.id.xq_sc){
            post2();
            Toast.makeText(shopping.this, "商品已收藏", Toast.LENGTH_SHORT).show();
        }
        else if(view.getId()==R.id.xq_buy){
            post();
            Toast.makeText(shopping.this, "商品已购买", Toast.LENGTH_SHORT).show();
        }
